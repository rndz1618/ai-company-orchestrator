"""Groq adapter — OpenAI-compatible API, free-tier friendly."""
...
class GroqAdapter(ProviderAdapter):
    ...
    def _get_client(self):
        if self._client is None:
            try:
                ...
                raise ImportError(
                    "openai package required (Groq uses OpenAI-compatible client). "
    ...
    def complete(
        ...
        *,
        ...
        cost = estimate_cost("groq", model or DEFAULT_MODEL, tokens_in, tokens_out)
